$(document).ready(function(){
    ...
    let member2 = ModelControllers.Members.add({id: Core.generateAutoNumber(), name: "Tankred", assignedTodoItems: [], doneTodoItems: [], signedIn: false});
    let member3 = ModelControllers.Members.add({id: Core.generateAutoNumber(), name: "Nils Eivind", assignedTodoItems: [], doneTodoItems: [], signedIn: false});
    let member4 = ModelControllers.Members.add({id: Core.generateAutoNumber(), name: "Danielini", assignedTodoItems: [], doneTodoItems: [], signedIn: false});
});